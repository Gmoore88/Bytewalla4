...
public class RIBInformationBaseTLV extends BaseTLV {
	 ...
	 * 0                   1                   2                   3
      ...
      +-+-+-+-+-+-+-+-+
	 */
	public void createTLV(IByteBuffer buf, HashMap<String, EpidemicNeighbor> neighbors) {
		...
		SDNV.encode(0, buf, 2);
		//P Value
		SDNV.encode(EpidemicNeighbor.getLongP(1.0), buf, 2);
		//Flag
		buf.put((byte)0);
		...
		while( neids.hasNext() )
		{
			...
			EpidemicNeighbor pn = neighbors.get(eid);
			//String id
