...
public class EpidemicNeighbor {
	public static enum EpidemicNeighborRecvState {
		...
		EpidemicNeighborRecvState() {
			caption = "";
		}

		EpidemicNeighborRecvState(String c) {
			caption = c;
		}
	...
	public static enum EpidemicNeighborSendState {
		...
		EpidemicNeighborSendState() {
			caption = "";
		}

		EpidemicNeighborSendState(String c) {
			caption = c;
		}
	...
	public static short getLongP(double d) {
		return (short) (d * EpidemicNeighbor.P_SHORT);
	}
	...
	protected EpidemicNeighborRecvState recvState_ = EpidemicNeighborRecvState.UNDEFINED;
	protected int recvTansactionId = 0;
	protected short remote_instance_ = getNextInstance();
	protected String remoteEid;
	protected EpidemicNeighborSendState sendState_ = EpidemicNeighborSendState.UNDEFINED;
	public BundleOffer bundleOffer = null;
	public boolean acked = false;

	public EpidemicNeighbor(String endpointID) {
		remoteEid = endpointID;
	}

	public EpidemicNeighborRecvState getRecvState() {
		return recvState_;
	}

	public EpidemicNeighborSendState getSendState() {
		return sendState_;
	}
	...
	public void setRecvState(EpidemicNeighborRecvState synAckSent) {
		recvState_ = synAckSent;
	}

	public void setSendState(EpidemicNeighborSendState synsent) {
		sendState_ = synsent;
	}
